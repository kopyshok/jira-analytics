...
- `query.py` — `build_overview(developer_ids, only_open, show_reviewed)`: выборка задач (поле «Разработчик» + тех. анализ по исполнителю), факт из `Worklog`, признаки, сводка на человека с медианой точности оценок.
