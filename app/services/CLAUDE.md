...
- `flags.py` — чистые функции: `compute_flags` (восемь признаков, включая `idlespent` — часы списаны, а задача в группе «не начаты») и `flag_signature` (снимок причины). ORM сюда не заходит.
