...
Проприетарный продукт. Исходный код открыт только для ознакомления — использование,
установка и распространение возможны исключительно по отдельному письменному
лицензионному договору с правообладателем. Условия — [LICENSE](LICENSE).

Компоненты третьих лиц и их лицензии перечислены в
[THIRD-PARTY-NOTICES.md](THIRD-PARTY-NOTICES.md); перечень обновляется командой
`py -3.10 scripts/gen_third_party_notices.py` при изменении зависимостей.
